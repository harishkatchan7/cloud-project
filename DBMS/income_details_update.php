...
<div id="header" class="container" >
		...
		<div id="menu">
			<ul>
				...
				<li class="current_page_item"><a href="income_details.php" accesskey="3" title="">Details</a></li>
...
<form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST">
  ...
  <table width="500" border="0" cellspacing="5" cellpadding="5">
    <tr>
      ...
      <td><input value="<?php echo $row_dynamic_form['salary']; ?>" type="text" name="salary" id="salary" /></td>
    </tr>
    <tr>
      <td>HRA:&nbsp;</td>
      <td><input value="<?php echo $row_dynamic_form['hra']; ?>" type="text" name="hra" id="hra" /></td>
    </tr>
    <tr>
      <td>Medical Expenses:</td>
      <td><input value="<?php echo $row_dynamic_form['medical_expense']; ?>" type="text" name="med_exp" id="med_exp" /></td>
    </tr>
    <tr>
      <td>Housing Loan:</td>
      <td><input value="<?php echo $row_dynamic_form['housing_loan']; ?>" type="text" name="housing_loan" id="housing_loan" /></td>
    </tr>
    <tr>
      <td>Capital Gain:</td>
      <td><input value="<?php echo $row_dynamic_form['capital_gains']; ?>" type="text" name="capital_gain" id="capital_gain" /></td>
    </tr>
    <tr>
      <td>Agricultural Income:</td>
      <td><input value="<?php echo $row_dynamic_form['agricultural_income']; ?>" type="text" name="agri_income" id="agri_income" /></td>
    </tr>
    <tr>
      <td>Other Income: </td>
      <td><input value="<?php echo $row_dynamic_form['other_income']; ?>" type="text" name="other_income" id="other_income" /></td>
    </tr>
  </table>
  <p>&nbsp;</p>
  <table width="500" border="0" cellspacing="5" cellpadding="5">
    <tr>
      <td width="90">&nbsp;</td>
      <td width="110"><input type="submit" name="submit" id="submit" value="Submit" /></td>
      <td width="200"><input type="reset" name="reset" id="reset" value="Reset" /></td>
      <td width="35">&nbsp;</td>
    </tr>
</table>
  <p>
